    ...
    <div className={styles.page}>
      <main className={styles.main}>
        <section className={styles.intro}>
          ...
          <p>
            A <strong>full‑stack</strong> starter built with:
          </p>
          <ul>
            <li>
              <strong>Next.js v14</strong> – React framework with Server‑Side
              Rendering (SSR), Static Site Generation (SSG), and API routes.
            </li>
            <li>
              <strong>TypeScript v5</strong> – static typing for safer code.
            </li>
            <li>
              <strong>FastAPI v0.115</strong> – async Python web framework,
              automatic OpenAPI docs, and high performance.
            </li>
            <li>
              <strong>Python v3.12</strong> – modern language features and
              improved performance.
            </li>
            <li>
              <strong>PostgreSQL v15</strong> – ACID‑compliant relational DB.
            </li>
            <li>
              <strong>React‑Query</strong> – data‑fetching & caching layer.
            </li>
            <li>
              <strong>Axios</strong> – HTTP client with interceptor‑based error
              handling.
            </li>
          </ul>
        </section>
        <section className={styles.ctas}>
          <a href="https://github.com" className="secondary">
            View Repository
          </a>
        </section>
      </main>
