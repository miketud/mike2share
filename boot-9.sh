    ...
    <div className={styles.page}>
      <main className={styles.main}>
        <section className={styles.intro}>
          ...
          <p>
            A clean, modern baseline for building full-stack applications with
            Next.js, TypeScript, and Python.
          </p>

          <p>
            Everything here is intentionally minimal — no frameworks, no magic,
            just solid defaults you can evolve.
          </p>
        </section>

        <section className={styles.ctas}>
          <a href="/docs" className="primary">
            Get Started
          </a>
